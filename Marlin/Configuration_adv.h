...
#define MAX_CONSECUTIVE_LOW_TEMPERATURE_ERROR_ALLOWED 3 //Kaimberex experimental testing for Sprite high heat hot end
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 500 //Kaimberex CRTouch Support
  ...
  #define BLTOUCH_FORCE_SW_MODE //Kaimberex CRTouch Support
   ...
   */
  #define BLTOUCH_HS_MODE true //Kaimberex CRTouch Support
...
//
#define ASSISTED_TRAMMING //Kaimberex Enable Tramming
  ...
  //#define TRAMMING_POINT_XY { {  56, 73 }, { 226,  73 }, { 226, 226 }, { 56, 226 } } //Kaimberex adjusted for sprite with CR touch
  //#define TRAMMING_POINT_XY { {  40, 40 }, { 180,  40 }, { X_CENTER, Y_CENTER }, { 180, 180 }, { 40, 180 } } //Kaimberex Add center Tramming Point and adjust for beds offsets

  // Define position names for probe points.
  #define TRAMMING_POINT_NAME_1 "Front-Left"
  #define TRAMMING_POINT_NAME_2 "Front-Right"
  //#define TRAMMING_POINT_NAME_3 "Center" //Kaimberex Add Center Tramming Point
  #define TRAMMING_POINT_NAME_3 "Back-Right"
  #define TRAMMING_POINT_NAME_4 "Back-Left"

  #define RESTORE_LEVELING_AFTER_G35    // Enable to restore leveling setup after operation
  #define REPORT_TRAMMING_MM          // Report Z deviation (mm) for each point relative to the first //Kaimberex

  #define ASSISTED_TRAMMING_WIZARD    // Add a Tramming Wizard to the LCD menu //Kaimberex Enable Tramming Wizard
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define STATUS_MESSAGE_TIMEOUT_SEC 30 // (seconds) //Kaimberex

  // On the Info Screen, display XY with one decimal place when possible
  //#define LCD_DECIMAL_SMALL_XY

  // Show the E position (filament used) during printing
  #define LCD_SHOW_E_TOTAL //Kaimberex
...
#define SET_PROGRESS_MANUALLY //Kaimberex OctoPrint Support
#if ENABLED(SET_PROGRESS_MANUALLY)
  #define SET_PROGRESS_PERCENT            // Add 'P' parameter to set percentage done
  #define SET_REMAINING_TIME              // Add 'R' parameter to set remaining time
  #define SET_INTERACTION_TIME          // Add 'C' parameter to set time until next filament change or other user interaction //Kaimberex OctoPrint Support
  #define M73_REPORT                    // Report M73 values to host //Kaimberex OctoPrint Support
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_SORT_ALPHA //Kaimberex Sort SDCard alphabetically
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' //Kaimberex OctoPrint Support
  #define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol //Kaimberex OctoPrint Support
  #define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands //Kaimberex OctoPrint Support
   ...
   */
  #define SD_ABORT_ON_ENDSTOP_HIT //Kaimberex enable
  ...
  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>' //Kaimberex enable
 ...
 */
  ...
  #define STATUS_FAN_FRAMES 4       // :[0,1,2,3,4] Number of fan animation frames //Kaimberex
  #define STATUS_HEAT_PERCENT       // Show heating in a progress bar //Kaimberex
  #define BOOT_MARLIN_LOGO_ANIMATED // Animated Marlin logo. Costs ~3260 (or ~940) bytes of flash. //Kaimberex
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement) //Kaimberex enable
  #define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA! //Kaimberex enable
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 //Kaimberex enable

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping //Kaimberex enable
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 64 //Kaimberex
#else
...
#define TX_BUFFER_SIZE 32 //Kaimberex

// Host Receive Buffer Size
// Without XON/XOFF flow control (see SERIAL_XON_XOFF below) 32 bytes should be enough.
// To use flow control, set this buffer size to at least 1024 bytes.
// :[0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
#define RX_BUFFER_SIZE 2048 //Kaimberex
 ...
 */
#define EMERGENCY_PARSER //Kaimberex OctoPrint Emergency Stop Support
 ...
 */
#define REALTIME_REPORTING_COMMANDS //Kaimberex OctoPrint
#if ENABLED(REALTIME_REPORTING_COMMANDS)
  #define FULL_REPORT_TO_HOST_FEATURE   // Auto-report the machine status like Grbl CNC //Kaimberex OctoPrint
#endif
...
#define ADVANCED_OK //Kaimberex Enable
 ...
 */
#define ADVANCED_PAUSE_FEATURE //Kaimberex Filament Runout Sensor Support
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         60  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     20  // (mm/s) Unload filament feedrate. This can be pretty fast. //Kaimberex Increased feedrate
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   12  // (mm/s) Load filament feedrate. This can be pretty fast. //Kaimberex Increased feedrate
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change. //Kaimberex enable
 ...
 */
#define AUTO_REPORT_POSITION //Kaimberex OctoPrint Support
...
#define GCODE_CASE_INSENSITIVE  // Accept G-code sent to the firmware in lowercase //Kaimberex enable
