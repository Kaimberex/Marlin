 ...
 */
   ...
   */
    ...
    // BLTouch can't run in 5V mode with a 3.3V probe pin
      ...
      static_assert(!(strcmp(STRINGIFY(BLTOUCH_HS_MODE), "1") && strcmp(STRINGIFY(BLTOUCH_HS_MODE), "true") \
                   && strcmp(STRINGIFY(BLTOUCH_HS_MODE), "0") && strcmp(STRINGIFY(BLTOUCH_HS_MODE), "false") \
